...
import { Heart, Shield, AlertCircle, Pill, Filter, ChevronDown, Phone, Search, Star, Truck, X, ShoppingCart, CheckCircle, Baby, Thermometer, Clock, Users, Stethoscope } from "lucide-react";
...
const pregnancyMedicines = [
  {
    ...
    description:
      "Folic Acid is essential for preventing neural tube defects in developing babies. Recommended for all women planning pregnancy and during the first trimester.",
    rating: 4.8,
    brand: "Mankind",
    dosage: "5mg",
    quantity: "30 tablets",
  ...
  },
  {
    ...
    description:
      "Used for treating iron deficiency anemia in pregnancy when oral iron is not tolerated or effective. Administered by healthcare professionals.",
    rating: 4.6,
    brand: "Emcure",
    dosage: "100mg/5mL",
    quantity: "1 vial",
...
const categories = [
  ...
  { id: "vitamins", label: "Prenatal Vitamins", icon: <Heart className="w-4 h-4" /> },
  { id: "injections", label: "Injections", icon: <Stethoscope className="w-4 h-4" /> },
  { id: "hormones", label: "Hormone Support", icon: <Baby className="w-4 h-4" /> },
  { id: "diabetes", label: "Diabetes Care", icon: <AlertCircle className="w-4 h-4" /> }
];
...
export default function PregnancyPage() {
  ...
  const [selectedProduct, setSelectedProduct] = useState<typeof pregnancyMedicines[0] | null>(null);
  ...
  const filteredProducts = pregnancyMedicines
    .filter(product => {
      // Search filter
      if (searchQuery) {
  ...
  const handleAddToCart = (product: typeof pregnancyMedicines[0]) => {
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
              <div className="max-w-4xl mx-auto">
                <div className="inline-flex items-center gap-1 bg-yellow-500 px-2 py-1 rounded-full mb-2">
                  ...
                  <span className="text-xs font-bold text-white">Pregnancy Care Specialists</span>
                </div>
      ...
      <div className="container mx-auto px-3 py-6">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-4 mb-4">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              ...
              <h3 className="text-xl font-bold text-blue-900">
                Browse <span className="text-yellow-500">Pregnancy Medicines</span>
              ...
              >
                ...
                <div className="relative h-32 sm:h-40 md:h-48 overflow-hidden bg-gradient-to-br from-blue-50 to-white">
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src = "https://via.placeholder.com/300x300?text=Pregnancy+Medicine";
                    }}
                  />
                  {/* Badges */}
        ...
        <div className="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-4 mb-8">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-yellow-800 text-lg mb-2">⚠️ Pregnancy Safety First</h3>
        ...
        {/* Pregnancy Timeline Cards */}
        <div className="mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Pregnancy Timeline Care</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              {
                trimester: "First Trimester",
                weeks: "1-12 weeks",
                focus: "Folic Acid, Thyroid Support",
                icon: "🌱",
                color: "bg-blue-50"
              },
              {
                ...
                weeks: "13-27 weeks",
                focus: "Iron, Calcium, Multivitamins",
                icon: "🌿",
                color: "bg-yellow-50"
              },
              {
              ...
              <div key={index} className={`${stage.color} rounded-xl p-4 border border-gray-200`}>
                ...
                <div>
                  <p className="text-sm text-gray-700"><span className="font-medium">Focus:</span> {stage.focus}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-white border border-green-200 rounded-xl p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-bold text-gray-900">Essential Nutrients</h3>
            </div>
            <ul className="space-y-2">
              <li className="flex items-center gap-2 text-sm text-gray-600">
                <CheckCircle className="w-4 h-4 text-green-500" />
              ...
              <div className="p-4">
                ...
                <div className="relative h-48 sm:h-64 mb-4 rounded-lg overflow-hidden bg-gradient-to-br from-blue-50 to-white">
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src = "https://via.placeholder.com/400x400?text=Pregnancy+Medicine";
                    }}
                  />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-yellow-800">Pregnancy Safety Notice</span>
                    </div>
                    <p className="text-xs text-yellow-700 mt-1">
                      {selectedProduct.prescription
                        ? "This medicine requires obstetrician prescription and regular monitoring during pregnancy."
                        : "Consult your doctor before use. Regular pregnancy check-ups are recommended."
                      }
                    </p>
                  </div>
        ...
        <div className="bg-gradient-to-r from-blue-700 to-blue-800 rounded-xl p-6 text-center text-white shadow-lg">
          <div className="inline-flex items-center gap-2 bg-yellow-500/20 backdrop-blur-sm px-3 py-1.5 rounded-full mb-4">
            ...
            <span className="text-sm font-bold">24/7 Pregnancy Support</span>
          </div>

          <h2 className="text-xl font-bold mb-3">Need Obstetrician Consultation?</h2>
